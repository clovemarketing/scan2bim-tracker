    ...
    <div className="page">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={openAdd} className="btn-primary"><Plus size={14} /> Log Hours</button>
        </div>
      </div>
        ...
        <>
          ...
          <div className="card mb-5 flex flex-wrap gap-4 items-end">
            ...
            <div>
              ...
              <select className="input w-44" value={filterTeamLead} onChange={(e) => setFilterTeamLead(e.target.value)}>
                <option>All</option>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <button onClick={() => setDateOpen(!dateOpen)}
                  className="input w-36 text-left flex items-center justify-between gap-1 cursor-pointer">
            ...
            {(filterEmp !== 'All' || filterProj !== 'All' || filterTeamLead !== 'All' || filterType !== 'All' || logDatePreset !== 'all') && (
              <button className="btn-secondary text-xs self-end" onClick={() => { setFilterEmp('All'); setFilterProj('All'); setFilterTeamLead('All'); setFilterType('All'); setLogDatePreset('all'); setLogDateFrom(''); setLogDateTo(''); setDateOpen(false); }}>
                Clear Filters
              </button>
            )}
          ...
          {loading ? (
            ...
            <DataTable
              ...
              actions={{
                renderCell: (colIndex, val, row, sheetRowIdx) => {
                  if (colIndex === 8) {
                  ...
                  if (colIndex === 10) {
                    ...
                    return (
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <button
                          onClick={() => openEditActEff(row, filteredRowIndices[sheetRowIdx])}
        ...
        <>
          ...
          <div className="card mb-5 flex flex-wrap gap-4 items-end">
            <div>
              ...
              <select className="input w-36" value={aMonth} onChange={(e) => setAMonth(e.target.value)}>
            ...
            <div>
              <label className="label">Employee</label>
              <select className="input w-44" value={aEmp} onChange={(e) => setAEmp(e.target.value)}>
            ...
            <div>
              <label className="label">Project</label>
              <select className="input w-52" value={aProj} onChange={(e) => setAProj(e.target.value)}>
            ...
            <div>
              ...
              <select className="input w-40" value={aDept} onChange={(e) => setADept(e.target.value)}>
            ...
            <div>
              ...
              <select className="input w-40" value={aStatus} onChange={(e) => setAStatus(e.target.value)}>
            ...
            <div>
              <label className="label">Team Lead</label>
              <select className="input w-44" value={aTeamLead} onChange={(e) => setATeamLead(e.target.value)}>
            ...
            <div>
              <label className="label">Type</label>
              <select className="input w-36" value={aType} onChange={(e) => setAType(e.target.value)}>
            ...
            <div>
              ...
              <div className="flex gap-1 items-center flex-wrap">
                ...
                <select
                  className={`input w-20 text-xs ${targetAllMonths ? 'opacity-40 pointer-events-none' : ''}`}
                  value={aYear}
            ...
            {hasAnalyticsFilters && (
              <button className="btn-secondary text-xs self-end" onClick={clearAnalyticsFilters}>Clear Filters</button>
            )}
            <div className="text-sm text-slate-500 self-end pb-2 ml-auto">
